...
case $typed in
    ...
    echo "PGMove Unencrypt" > /var/plexguide/pg.transport ;;
    2 )
    echo "me" > /var/plexguide/pgclone.transport
    echo "PGMove Encrypted" > /var/plexguide/pg.transport ;;   
    3 )
    echo "bu" > /var/plexguide/pgclone.transport
    echo "PGBlitz Unencrypt" > /var/plexguide/pg.transport ;;
    4 )
    echo "be" > /var/plexguide/pgclone.transport
    echo "PGBlitz Encrypted" > /var/plexguide/pg.transport ;;    
    5 )
    echo "le" > /var/plexguide/pgclone.transport
    echo "PG Local Edition" > /var/plexguide/pg.transport ;;    
    * )
        transportselect ;;
esac
}
